...
local UnnamedHubFolder = "UnnamedHub"
local ConfigurationFolder = UnnamedHubFolder.."/Configurations"
local ConfigurationExtension = ".rfld"
local UnnamedHubNameErrorName = "Unnamed Hub"
local ErrorMessage = "Please take a screenshot of this error, and send it to one of the \ndevelopers!"

local UnnamedHubLibrary = {
	Flags = {},
	Theme = {
		Default = {
			TextFont = "Default",
...
local UnnamedHub = game:GetObjects("rbxassetid://10804731440")[1]



if gethui then
	UnnamedHub.Parent = gethui()
elseif syn.protect_gui then 
	syn.protect_gui(UnnamedHub)
	UnnamedHub.Parent = CoreGui
elseif CoreGui:FindFirstChild("RobloxGui") then
	UnnamedHub.Parent = CoreGui:FindFirstChild("RobloxGui")
else
	UnnamedHub.Parent = CoreGui
end
...
if gethui then
	for _, Interface in ipairs(gethui():GetChildren()) do
		if Interface.Name == UnnamedHub.Name and Interface ~= UnnamedHub then
			Interface.Enabled = false
			Interface.Name = "UnnamedHub-Old"
		end
	end
else
...
local Main = UnnamedHub.Main
local Topbar = Main.Topbar
local Elements = Main.Elements
local LoadingFrame = Main.LoadingFrame
local TabList = Main.TabList

UnnamedHub.DisplayOrder = 100
...
local Notifications = UnnamedHub.Notifications

local SelectedTheme = UnnamedHubLibrary.Theme.Default

function ChangeTheme(ThemeName)
	SelectedTheme = UnnamedHubLibrary.Theme[ThemeName]
	for _, obj in ipairs(UnnamedHub:GetDescendants()) do
	...
	UnnamedHub.Main.BackgroundColor3 = SelectedTheme.Background
	UnnamedHub.Main.Topbar.BackgroundColor3 = SelectedTheme.Topbar
	UnnamedHub.Main.Topbar.CornerRepair.BackgroundColor3 = SelectedTheme.Topbar
	UnnamedHub.Main.Shadow.Image.ImageColor3 = SelectedTheme.Shadow
	
	UnnamedHub.Main.Topbar.ChangeSize.ImageColor3 = SelectedTheme.TextColor
	UnnamedHub.Main.Topbar.Hide.ImageColor3 = SelectedTheme.TextColor
	UnnamedHub.Main.Topbar.Theme.ImageColor3 = SelectedTheme.TextColor
...
local function LoadConfiguration(Configuration)
	...
	for FlagName, FlagValue in next, Data do
		if UnnamedHubLibrary.Flags[FlagName] then
			spawn(function() 
				if UnnamedHubLibrary.Flags[FlagName].Type == "ColorPicker" then
					UnnamedHubLibrary.Flags[FlagName]:Set(UnpackColor(FlagValue))
				else
					if UnnamedHubLibrary.Flags[FlagName].CurrentValue or UnnamedHubLibrary.Flags[FlagName].CurrentKeybind or UnnamedHubLibrary.Flags[FlagName].CurrentOption or UnnamedHubLibrary.Flags[FlagName].Color ~= FlagValue then UnnamedHubLibrary.Flags[FlagName]:Set(FlagValue) end
				end    
			end)
		else
			--UnnamedHubLibrary:Notify({Title = "Flag Error", Content = "Unnamed Hub was unable to find '"..FlagName.. "'' in the current script"})
		end
	end
end
...
local function SaveConfiguration()
	...
	local Data = {}
	for i,v in pairs(UnnamedHubLibrary.Flags) do
...
function UnnamedHubLibrary:Notify(NotificationSettings)
	spawn(function()
		...
		if NotificationSettings.Actions then
			for _, Action in pairs(NotificationSettings.Actions) do
				...
				if SelectedTheme ~= UnnamedHubLibrary.Theme.Default then
				...
				NewAction.MouseButton1Click:Connect(function()
					...
					if not Success then
						warn(UnnamedHubNameErrorName.." | Action: "..Action.Name.." Callback Error " ..tostring(Response).." "..ErrorMessage)
					end
		...
		if UnnamedHub.Name == "Rayfield" then
...
function Hide()
	Debounce = true
	UnnamedHubLibrary:Notify({Title = "Interface Hidden", Content = "The interface has been hidden, you can unhide the interface by tapping RightShift", Duration = 7})
...
function UnnamedHubLibrary:CreateWindow(Settings)
	...
	pcall(function()
		...
		if not isfolder(UnnamedHubFolder.."/".."Configuration Folders") then
	...
	if Settings.Discord then
		if not isfolder(UnnamedHubFolder.."/Discord Invites") then
			makefolder(UnnamedHubFolder.."/Discord Invites")
		end
		if not isfile(UnnamedHubFolder.."/Discord Invites".."/"..Settings.Discord.Invite..ConfigurationExtension) then
			if request then
				request({
			...
			if Settings.Discord.RememberJoins then
				writefile(UnnamedHubFolder.."/Discord Invites".."/"..Settings.Discord.Invite..ConfigurationExtension,"UnnamedHub RememberJoins is true for this invite, this invite will not ask you to join again")
			end
		else
	...
	if Settings.KeySystem then
		...
		if not isfolder(UnnamedHubFolder.."/Key System") then
			makefolder(UnnamedHubFolder.."/Key System")
		end
		...
		if Settings.KeySettings.GrabKeyFromSite then
			...
			if not Success then
				warn(UnnamedHubNameErrorName.." | "..Settings.KeySettings.Key.." Error " ..tostring(Response).." "..ErrorMessage)
			end
		end
		...
		if isfile(UnnamedHubFolder.."/Key System".."/"..Settings.KeySettings.FileName..ConfigurationExtension) then
			if readfile(UnnamedHubFolder.."/Key System".."/"..Settings.KeySettings.FileName..ConfigurationExtension) == Settings.KeySettings.Key then
				Passthrough = true
			end
		end
			...
			KeyUI.Main.Input.InputBox.FocusLost:Connect(function()
				if KeyMain.Input.InputBox.Text == Settings.KeySettings.Key then
					...
					if Settings.KeySettings.SaveKey then
						if writefile then
							writefile(UnnamedHubFolder.."/Key System".."/"..Settings.KeySettings.FileName..ConfigurationExtension, Settings.KeySettings.Key)
						end
						UnnamedHubLibrary:Notify({Title = "Key System", Content = "The key for this script has been saved successfully"})
					end
				else
		...
		function Tab:CreateButton(ButtonSettings)
			...
			Button.Interact.MouseButton1Click:Connect(function()
				...
				if not Success then
					...
					warn(UnnamedHubNameErrorName.." | "..ButtonSettings.Name.." Callback Error " ..tostring(Response).." "..ErrorMessage)
					wait(0.5)
					Button.Title.Text = ButtonSettings.Name
		...
		function Tab:CreateColorPicker(ColorPickerSettings) -- by Throit
			...
			if Settings.ConfigurationSaving then
				if Settings.ConfigurationSaving.Enabled and ColorPickerSettings.Flag then
					UnnamedHubLibrary.Flags[ColorPickerSettings.Flag] = ColorPickerSettings
				end
			end
		...
		function Tab:CreateInput(InputSettings)
			...
			Input.InputFrame.InputBox.FocusLost:Connect(function()
				...
				if not Success then
					...
					warn(UnnamedHubNameErrorName.." | "..InputSettings.Name.." Callback Error " ..tostring(Response).." "..ErrorMessage)
					wait(0.5)
					Input.Title.Text = InputSettings.Name
		...
		function Tab:CreateDropdown(DropdownSettings)
				...
				DropdownOption.Interact.MouseButton1Click:Connect(function()
					if Dropdown.Selected.Text ~= Option then
						...
						if not Success then
							...
							warn(UnnamedHubNameErrorName.." | "..DropdownSettings.Name.." Callback Error " ..tostring(Response).." "..ErrorMessage)
							wait(0.5)
							Dropdown.Title.Text = DropdownSettings.Name
							TweenService:Create(Dropdown, TweenInfo.new(0.6, Enum.EasingStyle.Quint), {BackgroundColor3 = SelectedTheme.ElementBackground}):Play()
			...
			if Settings.ConfigurationSaving then
				if Settings.ConfigurationSaving.Enabled and DropdownSettings.Flag then
					UnnamedHubLibrary.Flags[DropdownSettings.Flag] = DropdownSettings
				end
			end
		...
		function Tab:CreateKeybind(KeybindSettings)
				...
				elseif KeybindSettings.CurrentKeybind ~= nil and (input.KeyCode == Enum.KeyCode[KeybindSettings.CurrentKeybind] and not processed) then -- Test
					...
					if not KeybindSettings.HoldToInteract then
						...
						if not Success then
							...
							warn(UnnamedHubNameErrorName.." | "..KeybindSettings.Name.." Callback Error " ..tostring(Response).." "..ErrorMessage)
							wait(0.5)
							Keybind.Title.Text = KeybindSettings.Name
							TweenService:Create(Keybind, TweenInfo.new(0.6, Enum.EasingStyle.Quint), {BackgroundColor3 = SelectedTheme.ElementBackground}):Play()
			...
			if Settings.ConfigurationSaving then
				if Settings.ConfigurationSaving.Enabled and KeybindSettings.Flag then
					UnnamedHubLibrary.Flags[KeybindSettings.Flag] = KeybindSettings
				end
			end
		...
		function Tab:CreateToggle(ToggleSettings)
			...
			Toggle.Interact.MouseButton1Click:Connect(function()
				...
				if not Success then
					...
					TweenService:Create(Toggle.UIStroke, TweenInfo.new(0.6, Enum.EasingStyle.Quint), {Transparency = 1}):Play()
					if Toggle.Title.Text == "Damage DIO" then
					   Toggle.Title.Text = "DIO hasnt spawned."
					else
					   Toggle.Title.Text = "Callback Error"
					end
					warn(UnnamedHubNameErrorName.." | "..ToggleSettings.Name.." Callback Error " ..tostring(Response).." "..ErrorMessage)
					wait(0.5)
					Toggle.Title.Text = ToggleSettings.Name
					TweenService:Create(Toggle, TweenInfo.new(0.6, Enum.EasingStyle.Quint), {BackgroundColor3 = SelectedTheme.ElementBackground}):Play()
					TweenService:Create(Toggle.UIStroke, TweenInfo.new(0.6, Enum.EasingStyle.Quint), {Transparency = 0}):Play()
			...
			if Settings.ConfigurationSaving then
				if Settings.ConfigurationSaving.Enabled and ToggleSettings.Flag then
					UnnamedHubLibrary.Flags[ToggleSettings.Flag] = ToggleSettings
				end
			end
		...
		function Tab:CreateSlider(SliderSettings)
					...
					if Dragging then
						...
						if SliderSettings.CurrentValue ~= NewValue then
							...
							if not Success then
								...
								warn(UnnamedHubNameErrorName.." | "..SliderSettings.Name.." Callback Error " ..tostring(Response).." "..ErrorMessage)
								wait(0.5)
								Slider.Title.Text = SliderSettings.Name
								TweenService:Create(Slider, TweenInfo.new(0.6, Enum.EasingStyle.Quint), {BackgroundColor3 = SelectedTheme.ElementBackground}):Play()
			...
			if Settings.ConfigurationSaving then
				if Settings.ConfigurationSaving.Enabled and SliderSettings.Flag then
					UnnamedHubLibrary.Flags[SliderSettings.Flag] = SliderSettings
				end
			end
...
function UnnamedHubLibrary:Destroy()
	UnnamedHub:Destroy()
end
...
function UnnamedHubLibrary:LoadConfiguration()
	if CEnabled then
		pcall(function()
			if isfile(ConfigurationFolder .. "/" .. CFileName .. ConfigurationExtension) then
				LoadConfiguration(readfile(ConfigurationFolder .. "/" .. CFileName .. ConfigurationExtension))
				UnnamedHubLibrary:Notify({Title = "Configuration Loaded", Content = "The configuration file for this script has been loaded from a previous session"})
			end
		end)
	end
end

task.delay(5, UnnamedHubLibrary.LoadConfiguration, UnnamedHubLibrary)

return UnnamedHubLibrary
